...
After completing these steps, executable files named `init_atmosphere_model`, `atmosphere_model`, and `build_tables` should have been created in the top-level MPAS directory.
