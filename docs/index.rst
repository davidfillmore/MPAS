...
.. note::
   ...
   These documentation pages are hosted on a fork of MPAS,
   `github.com/davidfillmore/MPAS <https://github.com/davidfillmore/MPAS>`_,
   which tracks the upstream project at
   `github.com/MPAS-Dev/MPAS-Model <https://github.com/MPAS-Dev/MPAS-Model>`_.
   They are a Sphinx conversion of two upstream PDF documents:

   - `MPAS-Atmosphere User's Guide, v8.3.0 <https://www2.mmm.ucar.edu/projects/mpas/mpas_atmosphere_users_guide_8.3.0.pdf>`_
   - `MPAS-Atmosphere Technical Note <https://www2.mmm.ucar.edu/projects/mpas/mpas_website_linked_files/MPAS-A_tech_note.pdf>`_

   The content is in the process of being updated for MPAS 8.4.
